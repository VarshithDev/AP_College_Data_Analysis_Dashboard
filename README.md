...
## Dashboard 
Main Page : Describes Colleges in Andhra Pradesh
...
College Performance page : Describes every feature about College like Ranking , Courses , Seats & EAMCET Ranks , Fees , Placements , etc 
...
College Comparison Page : Compare the two colleges with visuals and insights , so one can know which college is better
